...
# 13 "main.c"
#pragma config WDT = 2
#pragma config PBADEN = 2


asm("GLOBAL _task_idle, _task_disp, _task_um, _task_dois, _task_m1, _task_m2");
...
if (create_task(1, 6, &task_disp) == 0) return 0;
if (create_task(2, 5, &task_um) == 0) return 0;
if (create_task(3, 4, &task_dois) == 0) return 0;
if (create_task(5, 2, &task_m1) == 0) return 0;
if (create_task(6, 1, &task_m2) == 0) return 0;
