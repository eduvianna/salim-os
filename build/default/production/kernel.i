...
{ if (f_aptos.APTOS[f_aptos.task_running].task_state == RUNNING) { f_aptos.APTOS[f_aptos.task_running].task_state = state; f_aptos.APTOS[f_aptos.task_running].W_reg = WREG; f_aptos.APTOS[f_aptos.task_running].STATUS_reg = STATUS; f_aptos.APTOS[f_aptos.task_running].BSR_reg = BSR; stack_size = 0; while (STKPTR) { f_aptos.APTOS[f_aptos.task_running].task_stack.stack_data[stack_size].TOSU_reg = TOSU; f_aptos.APTOS[f_aptos.task_running].task_stack.stack_data[stack_size].TOSH_reg = TOSH; f_aptos.APTOS[f_aptos.task_running].task_stack.stack_data[stack_size].TOSL_reg = TOSL; stack_size++; asm("POP"); } f_aptos.APTOS[f_aptos.task_running].task_stack.stack_size = stack_size; }};


f_aptos.task_running = rr_scheduler();

# 132
{ STKPTR = 0; if (f_aptos.APTOS[f_aptos.task_running].task_stack.stack_size == 0) { asm("PUSH"); TOS = f_aptos.APTOS[f_aptos.task_running].task_ptr; } else { WREG = f_aptos.APTOS[f_aptos.task_running].W_reg; STATUS = f_aptos.APTOS[f_aptos.task_running].STATUS_reg; BSR = f_aptos.APTOS[f_aptos.task_running].BSR_reg; stack_size = f_aptos.APTOS[f_aptos.task_running].task_stack.stack_size-1; while (stack_size) { asm("PUSH"); TOSL = f_aptos.APTOS[f_aptos.task_running].task_stack.stack_data[stack_size].TOSL_reg; TOSH = f_aptos.APTOS[f_aptos.task_running].task_stack.stack_data[stack_size].TOSH_reg; TOSU = f_aptos.APTOS[f_aptos.task_running].task_stack.stack_data[stack_size].TOSU_reg; stack_size--; } } f_aptos.APTOS[f_aptos.task_running].task_state = RUNNING;};
...
do {
f_aptos.APTOS[f_aptos.task_running].task_stack.stack_data[stack_size].TOSU_reg = TOSU; f_aptos.APTOS[f_aptos.task_running].task_stack.stack_data[stack_size].TOSH_reg = TOSH; f_aptos.APTOS[f_aptos.task_running].task_stack.stack_data[stack_size].TOSL_reg = TOSL; stack_size++;
...
do {
asm("PUSH");
TOSL = f_aptos.APTOS[f_aptos.task_running].task_stack.stack_data[stack_size].TOSL_reg; TOSH = f_aptos.APTOS[f_aptos.task_running].task_stack.stack_data[stack_size].TOSH_reg; TOSU = f_aptos.APTOS[f_aptos.task_running].task_stack.stack_data[stack_size].TOSU_reg; stack_size--;
