...
asm("GLOBAL _task_idle, _task_lcd, _task_um, _task_dois, _task_tres, _task_m1, _task_m2");
...
if (create_task(1, 6, &task_lcd) == 0) return 0;
if (create_task(2, 5, &task_um) == 0) return 0;
if (create_task(3, 4, &task_dois) == 0) return 0;
if (create_task(4, 3, &task_tres) == 0) return 0;
